...
public static void main(String[] args) {
	...
	public static void proverka(String[] cards){
		...
		case "7": case "8": case "9": case "10":case "J": case "j":
		case "Q": case "q": case "K": case "k":	case "A": case "a":
		{
...
public static void Poker(String[] cards){
	...
	if(count==4){
	System.out.println(wordsCount+ "  kare"); break;
	
	}
	else if(count==3){
		System.out.println(wordsCount+ " set"); break;
	}
	else if(count==2){
